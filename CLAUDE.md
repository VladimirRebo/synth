...
Walter — личный, более продвинутый аналог Sonar: RAG для кодовых баз + VCS-автоматизации. Стек: **.NET** + **Vue 3/Vite**, **Qdrant**, **MongoDB**. Рабочее имя проекта — `Walter` (временно; кандидат `Synth`).
